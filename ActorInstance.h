...
class CActorInstance : public IActorInstance, public IFlyTargetableObject
{
	...
	public:
		...
		enum EType
		{
			...
			TYPE_HORSE,
			TYPE_GOTO,
			TYPE_MOUNT,		// ENABLE_MOUNT_SYSTEM_EX
	...
	public:
		WORD NextValidMotion();
		WORD GetCurrentMotionIndex() { return __GetCurrentMotionIndex(); }
#endif
	...
	protected:
		...
		WORD	m_awWeaponType; // GRM Update 16112023

#if defined(__BL_GRAPHIC_ON_OFF__)
	protected:
		bool m_bPrivateShopSign;
		bool m_bRenderActor;
		bool m_bRenderEffect;
		bool m_bIsInvisibleActor;
		DWORD m_dwShopDistance;
		BYTE m_bRank;
	...
	public:
		...
		BYTE GetRank() const;
		void AddPrivateShopSign();
		void RemovePrivateShopSign();
		bool HasPrivateShopSign() const;
		void SetPrivateShopDistance(DWORD dwShopDistance);
#endif
};
