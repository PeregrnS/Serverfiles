...
class CGraphicBase
{
	public:
		...
		static int GetNonPow2TextureSupportLevel() { return ms_nonPow2Support; };
	...
	public:
		...
		// IDirect3DDevice9Ex::ResetEx + D3DDISPLAYMODEEX (fullscreen).
		static HRESULT	ResetDeviceEx(D3DPRESENT_PARAMETERS* pPP);
