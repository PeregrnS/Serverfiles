...
class CGraphicExpandedImageInstance : public CGraphicImageInstance
{
	...
	public:
		...
		void SetExpandedRenderingRect(float fLeftTop, float fLeftBottom, float fTopLeft, float fTopRight, float fRightTop, float fRightBottom, float fBottomLeft, float fBottomRight, bool bScale = false);
