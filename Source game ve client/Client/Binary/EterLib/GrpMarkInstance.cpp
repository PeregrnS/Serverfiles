...
void CGraphicMarkInstance::Render(RECT* pClipRect)
#else
...
#if defined(ENABLE_CLIP_MASK)
void CGraphicMarkInstance::OnRender(RECT* pClipRect)
#else
...
#endif
{
	...
	float ex = m_v2Position.x + fRenderWidth - 0.5f;
	float ey = m_v2Position.y + fRenderHeight - 0.5f;
