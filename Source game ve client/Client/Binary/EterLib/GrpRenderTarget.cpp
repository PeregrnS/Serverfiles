...
CGraphicRenderTarget::CGraphicRenderTarget()
	: model_(nullptr), rotation_(false), created_(false), cam_distance_(1500.0f), light_position_(50.0f, 150.0f, 350.0f)
{}
...
void CGraphicRenderTarget::SetRenderAcce(uint32_t vnum)
{
	if (created_)
	{
		model_->ChangeAcce(vnum);
	}
}
