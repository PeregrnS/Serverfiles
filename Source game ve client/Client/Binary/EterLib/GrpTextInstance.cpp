...
#ifdef ENABLE_BATCHED_TEXT_RENDERING
...
// 	for (auto& kEmoji : m_emojiVector)
// 	{
// 		if (kEmoji.pInstance)
// 		{
// 			kEmoji.pInstance->SetWikiImage(true);
			
// 			int width = 0, height = 0;
// 			GetTextSize(&width, &height);
			
// 			RECT m_imageRenderBox = m_renderBox;
// 			int splitValue = (MAX(0, kEmoji.pInstance->GetHeight() - height) / 2);
// 			if (splitValue > 0)
// 				m_imageRenderBox.bottom += splitValue;
			
// 			kEmoji.pInstance->SetRenderBox(m_imageRenderBox);
// 		}
// 	}
// #endif
}
