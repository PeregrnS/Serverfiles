...
class CEterPackManager : public CSingleton<CEterPackManager>
{
	...
	public:
		...
		{
			return _GetFromPack(pData, 1, EPM_PASS, 1, 1, 1, c_szFileName, rMappedFile);
		}
