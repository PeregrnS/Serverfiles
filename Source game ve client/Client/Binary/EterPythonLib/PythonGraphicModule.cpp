...
PyObject* grpGetEffectOnOffLevel(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonGraphicOnOff::Instance().GetEffectOnOffLevel());
}

PyObject* grpGetPrivateShopOnOffLevel(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonGraphicOnOff::Instance().GetPrivateShopOnOffLevel());
}

PyObject* grpGetDropItemOnOffLevel(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonGraphicOnOff::Instance().GetDropItemOnOffLevel());
}

PyObject* grpGetPetOnOffStatus(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonGraphicOnOff::Instance().GetPetOnOffStatus());
}

PyObject* grpGetMountOnOffStatus(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonGraphicOnOff::Instance().GetMountOnOffStatus());
}

PyObject* grpGetNPCNameOnOffStatus(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonGraphicOnOff::Instance().GetNPCNameOnOffStatus());
}

PyObject* grpSetEffectOnOffLevel(PyObject* poSelf, PyObject* poArgs)
{
	BYTE bLevel;
	if (!PyTuple_GetByte(poArgs, 0, &bLevel))
		return Py_BuildException();

	if (!CPythonGraphicOnOff::Instance().SetEffectOnOffLevel(bLevel))
		return Py_BuildException();

	return Py_BuildNone();
}

PyObject* grpSetPrivateShopOnOffLevel(PyObject* poSelf, PyObject* poArgs)
{
	BYTE bLevel;
	if (!PyTuple_GetByte(poArgs, 0, &bLevel))
		return Py_BuildException();

	if (!CPythonGraphicOnOff::Instance().SetPrivateShopOnOffLevel(bLevel))
		return Py_BuildException();

	return Py_BuildNone();
}

PyObject* grpSetDropItemOnOffLevel(PyObject* poSelf, PyObject* poArgs)
{
	BYTE bLevel;
	if (!PyTuple_GetByte(poArgs, 0, &bLevel))
		return Py_BuildException();

	if (!CPythonGraphicOnOff::Instance().SetDropItemOnOffLevel(bLevel))
		return Py_BuildException();

	return Py_BuildNone();
}

PyObject* grpSetPetOnOffStatus(PyObject* poSelf, PyObject* poArgs)
{
	BYTE bLevel;
	if (!PyTuple_GetByte(poArgs, 0, &bLevel))
		return Py_BuildException();

	if (!CPythonGraphicOnOff::Instance().SetPetOnOffStatus(bLevel))
		return Py_BuildException();

	return Py_BuildNone();
}

PyObject* grpSetMountOnOffStatus(PyObject* poSelf, PyObject* poArgs)
{
	BYTE bLevel;
	if (!PyTuple_GetByte(poArgs, 0, &bLevel))
		return Py_BuildException();

	if (!CPythonGraphicOnOff::Instance().SetMountOnOffStatus(bLevel))
		return Py_BuildException();

	return Py_BuildNone();
}

PyObject* grpSetNPCNameOnOffStatus(PyObject* poSelf, PyObject* poArgs)
{
	BYTE bLevel;
	if (!PyTuple_GetByte(poArgs, 0, &bLevel))
		return Py_BuildException();

	if (!CPythonGraphicOnOff::Instance().SetNPCNameOnOffStatus(bLevel))
		return Py_BuildException();
...
#if defined(__BL_GRAPHIC_ON_OFF__)
		{ "GetEffectOnOffLevel",		grpGetEffectOnOffLevel,			METH_VARARGS },
		{ "GetPrivateShopOnOffLevel",	grpGetPrivateShopOnOffLevel,	METH_VARARGS },
		{ "GetDropItemOnOffLevel",		grpGetDropItemOnOffLevel,		METH_VARARGS },
		{ "GetPetOnOffStatus",			grpGetPetOnOffStatus,			METH_VARARGS },
		{ "GetMountOnOffStatus",		grpGetMountOnOffStatus,			METH_VARARGS },
		{ "GetNPCNameOnOffStatus",		grpGetNPCNameOnOffStatus,		METH_VARARGS },

		{ "SetEffectOnOffLevel",		grpSetEffectOnOffLevel,			METH_VARARGS },
		{ "SetPrivateShopOnOffLevel",	grpSetPrivateShopOnOffLevel,	METH_VARARGS },
		{ "SetDropItemOnOffLevel",		grpSetDropItemOnOffLevel,		METH_VARARGS },
		{ "SetPetOnOffStatus",			grpSetPetOnOffStatus,			METH_VARARGS },
		{ "SetMountOnOffStatus",		grpSetMountOnOffStatus,			METH_VARARGS },
		{ "SetNPCNameOnOffStatus",		grpSetNPCNameOnOffStatus,		METH_VARARGS },
#endif
