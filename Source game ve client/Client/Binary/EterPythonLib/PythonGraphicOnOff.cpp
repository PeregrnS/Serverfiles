...
bool CPythonGraphicOnOff::SetMountOnOffStatus(BYTE bVal)
{
	if (bVal >= EOPTIONLIMIT::MOUNT_LEVEL_COUNT)
		return false;
...
BYTE CPythonGraphicOnOff::GetMountOnOffStatus() const
{
	return m_bMountLevel;
}
...
bool CPythonGraphicOnOff::CanRenderMount() const
{
	return m_bMountLevel == 0;
}
