...
namespace UI
{
	...
	class CWindowManager : public CSingleton<CWindowManager>
	{
		...
		public:
			...
			CWindow* RegisterGifImageBox(PyObject* po, const char* c_szLayer); // gif support
...
#endif
			bool		RunMouseWheelEvent(long nLen);	// Mouse Wheel Support
			void		RunIMEUpdate();
			void		RunIMETabEvent();
