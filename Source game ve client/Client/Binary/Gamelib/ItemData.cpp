...
const char* CItemData::GetUseTypeString() const
{
	...
	switch (GetSubType())
	{
		...
		case USE_ADD_PENDANT_ATTRIBUTE:
			return DEF_STR(USE_ADD_PENDANT_ATTRIBUTE);
		case USE_ADD_PENDANT_FIVE_ATTRIBUTE:
			return DEF_STR(USE_ADD_PENDANT_FIVE_ATTRIBUTE);
		case USE_CHANGE_PENDANT_ATTRIBUTE:
			return DEF_STR(USE_CHANGE_PENDANT_ATTRIBUTE);
		case USE_CHANGE_ATTRIBUTE_DS:
			return DEF_STR(USE_CHANGE_ATTRIBUTE_DS);
	}
