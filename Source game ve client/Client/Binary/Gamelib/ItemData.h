...
class CItemData
{
	public:
		enum
		{
			...
			ITEM_APPLY_MAX_NUM = 5,	// Same value @ common/item_length.h
...
#endif
			USE_CHANGE_ATTRIBUTE_DS,
			USE_AVERAGE_DAMAGE_UP,				// 37
			USE_TITLE,
		};
		...
		enum EApplyTypes
		{
			...
			APPLY_ATTBONUS_STONE 			= 118,
			APPLY_ATTBONUS_BOSS 			= 119,
			APPLY_ATTBONUS_ELEMENTS 		= 120,
			APPLY_ENCHANT_ELEMENTS 			= 121,
			APPLY_ATTBONUS_CHARACTERS 		= 122,
			APPLY_ENCHANT_CHARACTERS 		= 123,
#endif
