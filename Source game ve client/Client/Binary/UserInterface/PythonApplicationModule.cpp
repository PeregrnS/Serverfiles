...
#ifdef ENABLE_SYSERR_VIEWER
PyObject* appSetClipboardData(PyObject* poSelf, PyObject* poArgs)
{
	char* szText = NULL;

	if (!PyTuple_GetString(poArgs, 0, &szText) || !szText)
		return Py_BuildException();
...
void initapp()
{
...
#ifdef ENABLE_SYSERR_VIEWER
		{"SetClipboardData",			appSetClipboardData,			METH_VARARGS },
#endif
	...
	PyModule_AddIntConstant(poModule, "__DAILY_QUESTS__", 1);
#else
	PyModule_AddIntConstant(poModule, "__DAILY_QUESTS__", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_CLIP_MASK", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CLIP_MASK", false);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_CHEST_DROP_INFO", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHEST_DROP_INFO", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_RENDER_TARGET_PREVIEW", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RENDER_TARGET_PREVIEW", 0);
#endif

#ifdef ENABLE_RENDER_TARGET_EX
	PyModule_AddIntConstant(poModule, "ENABLE_RENDER_TARGET_EX", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RENDER_TARGET_EX", 0);
#endif

#ifdef ENABLE_QUEST_RENDER_EVENT
	PyModule_AddIntConstant(poModule, "ENABLE_QUEST_RENDER_EVENT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_QUEST_RENDER_EVENT", 0);
#endif

#ifdef ENABLE_SWITCHBOT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SWITCHBOT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SWITCHBOT_SYSTEM", 0);
#endif

#ifdef ENABLE_DROP_INFO
	PyModule_AddIntConstant(poModule, "ENABLE_DROP_INFO", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DROP_INFO", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_GROUP_GUI", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_GROUP_GUI", 0);
#endif
...
#ifdef ENABLE_FLASH_APPLICATION
	PyModule_AddIntConstant(poModule, "ENABLE_FLASH_APPLICATION", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FLASH_APPLICATION", 0);
#endif

#ifdef ENABLE_INGAME_WIKI
	PyModule_AddIntConstant(poModule, "ENABLE_INGAME_WIKI", 1);
	#ifdef INGAME_WIKI_WOLFMAN
	PyModule_AddIntConstant(poModule, "INGAME_WIKI_WOLFMAN", 1);
	#else
	PyModule_AddIntConstant(poModule, "INGAME_WIKI_WOLFMAN", 0);
	#endif
#else
	#ifdef INGAME_WIKI_WOLFMAN
	PyModule_AddIntConstant(poModule, "INGAME_WIKI_WOLFMAN", 1);
...
#ifdef PM_IN_GLOBAL_CHAT
	PyModule_AddIntConstant(poModule, "PM_IN_GLOBAL_CHAT", 1);
#else
	PyModule_AddIntConstant(poModule, "PM_IN_GLOBAL_CHAT", 0);
#endif

#ifdef ENABLE_MOB_HP
	PyModule_AddIntConstant(poModule, "ENABLE_MOB_HP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MOB_HP", 0);
#endif

#ifdef ENABLE_PLAYER_HP
	PyModule_AddIntConstant(poModule, "ENABLE_PLAYER_HP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PLAYER_HP", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PLAYER_AFFECT_REMOVE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PLAYER_AFFECT_REMOVE", 0);
#endif

#ifdef ENABLE_SKILL_COSTUME_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_COSTUME_SYSTEM", 1);
	PyModule_AddIntConstant(poModule, "SKILL_COSTUME_EFFECT_COUNT", SKILL_COSTUME_EFFECT_COUNT);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_COSTUME_SYSTEM", 0);
#endif

#ifdef ENABLE_HIGHLIGHT_SLOT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_SLOT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_SLOT_SYSTEM", 0);
#endif

#ifdef ENABLE_HIGHLIGHT_SLOT_SYSTEM_EX
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_SLOT_SYSTEM_EX", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_SLOT_SYSTEM_EX", 0);
#endif

#ifdef ENABLE_HIGHLIGHT_SLOT_NEW_EFFECT
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_SLOT_NEW_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_SLOT_NEW_EFFECT", 0);
#endif

#ifdef ENABLE_METIN_STONE_QUEUE
	PyModule_AddIntConstant(poModule, "ENABLE_METIN_STONE_QUEUE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_METIN_STONE_QUEUE", 0);
#endif

#ifdef ENABLE_ADD_FRIEND_BUTTON_IN_WHISPERDIALOG
	PyModule_AddIntConstant(poModule, "ENABLE_ADD_FRIEND_BUTTON_IN_WHISPERDIALOG", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ADD_FRIEND_BUTTON_IN_WHISPERDIALOG", 0);
#endif

#ifdef ENABLE_BUFF_ITEMS_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_BUFF_ITEMS_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BUFF_ITEMS_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_MANAGER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_MANAGER", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_GOLD_MAX_EXTENDED", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GOLD_MAX_EXTENDED", 0);
#endif

#ifdef ENABLE_ATLASS_EXTENDED
	PyModule_AddIntConstant(poModule, "ENABLE_ATLASS_EXTENDED", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ATLASS_EXTENDED", 0);
#endif

#ifdef ENABLE_EXCHANGE_WINDOW_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_EXCHANGE_WINDOW_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXCHANGE_WINDOW_RENEWAL", 0);
#endif

#ifdef ENABLE_CHECKINOUT_UPDATE
	PyModule_AddIntConstant(poModule, "ENABLE_CHECKINOUT_UPDATE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHECKINOUT_UPDATE", 0);
#endif

#ifdef ENABLE_RENEWAL_ADD_STATS
	PyModule_AddIntConstant(poModule, "ENABLE_RENEWAL_ADD_STATS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RENEWAL_ADD_STATS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_BLEND", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_BLEND", 0);
#endif

#ifdef ENABLE_BOLD_FONTS
	PyModule_AddIntConstant(poModule, "ENABLE_BOLD_FONTS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BOLD_FONTS", 0);
#endif

#ifdef ENABLE_REFINE_UI_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_UI_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_UI_RENEWAL", 0);
#endif

#ifdef ENABLE_ATLAS_MOVE_TO_POS
	PyModule_AddIntConstant(poModule, "ENABLE_ATLAS_MOVE_TO_POS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ATLAS_MOVE_TO_POS", 0);
#endif

#if defined(ENABLE_PICK_FILTER)
	PyModule_AddIntConstant(poModule, "ENABLE_PICK_FILTER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PICK_FILTER", 0);
#endif

#ifdef ENABLE_EXTENDED_ATTRS
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_ATTRS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_ATTRS", 0);
#endif

#ifdef ENABLE_SAVE_BLOCK_ATTR
	PyModule_AddIntConstant(poModule, "ENABLE_SAVE_BLOCK_ATTR", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SAVE_BLOCK_ATTR", 0);
#endif
...
*/
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_BUNDLE_REQ", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_BUNDLE_REQ", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_PREMIUM_TIME", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_PREMIUM_TIME", 0);
#endif

#ifdef ENABLE_PRIVATE_SHOP_BUILD_LIMITATIONS
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_BUILD_LIMITATIONS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_BUILD_LIMITATIONS", 0);
#endif

#ifdef ENABLE_PRIVATE_SHOP_LOCKED_SLOTS
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_LOCKED_SLOTS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_LOCKED_SLOTS", 0);
#endif

#ifdef ENABLE_PRIVATE_SHOP_TIME_SORT
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_TIME_SORT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_TIME_SORT", 0);
#endif

#ifdef ENABLE_PRIVATE_SHOP_NO_RESULT_UPDATE
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_NO_RESULT_UPDATE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_NO_RESULT_UPDATE", 0);
#endif

#ifdef ENABLE_PRIVATE_SHOP_PRICE_SORT
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_PRICE_SORT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_PRICE_SORT", 0);
#endif

#ifdef ENABLE_PRIVATE_SHOP_DIFFERENT_PRICE_RESTRICTION
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_DIFFERENT_PRICE_RESTRICTION", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_DIFFERENT_PRICE_RESTRICTION", 0);
#endif

#ifdef ENABLE_PRIVATE_SHOP_CHANGE_LOOK
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_CHANGE_LOOK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_CHANGE_LOOK", 0);
#endif

#ifdef ENABLE_PRIVATE_SHOP_REFINE_ELEMENT
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_REFINE_ELEMENT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_REFINE_ELEMENT", 0);
#endif

#ifdef ENABLE_PRIVATE_SHOP_APPLY_RANDOM
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_APPLY_RANDOM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATE_SHOP_APPLY_RANDOM", 0);
#endif
/*
END OF PRIVATE SHOP DEFINES
*/
	...
	PyModule_AddIntConstant(poModule, "ENABLE_HWID_BAN", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HWID_BAN", 0);
#endif
...
#ifdef ENABLE_COSTUMEWINDOW_STICKED_TO_INVENTORYWINDOW
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUMEWINDOW_STICKED_TO_INVENTORYWINDOW", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUMEWINDOW_STICKED_TO_INVENTORYWINDOW", 0);
#endif

#ifdef ENABLE_SKILL_DESCRIPTION_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_DESCRIPTION_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_DESCRIPTION_RENEWAL", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "__SPIN_WHEEL_BOSS__", 1);
#else
	PyModule_AddIntConstant(poModule, "__SPIN_WHEEL_BOSS__", 0);
#endif
...
#ifdef __WHISPER_FUTURES__
	PyModule_AddIntConstant(poModule, "__WHISPER_FUTURES__", 1);
#else
	PyModule_AddIntConstant(poModule, "__WHISPER_FUTURES__", 0);
#endif

#ifdef ENABLE_GLOBAL_REWARD
	PyModule_AddIntConstant(poModule, "ENABLE_GLOBAL_REWARD", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GLOBAL_REWARD", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PIN_LOGIN", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PIN_LOGIN", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SPLIT_BY_COUNT",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SPLIT_BY_COUNT",	0);
#endif

#ifdef ENABLE_VOTE_4_BUFF
	PyModule_AddIntConstant(poModule, "ENABLE_VOTE_4_BUFF",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_VOTE_4_BUFF",	0);
#endif

#ifdef ENABLE_SHINING_ITEM_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SHINING_ITEM_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHINING_ITEM_SYSTEM", 0);
#endif

#ifdef ENABLE_RANK_PLAYER
	PyModule_AddIntConstant(poModule, "ENABLE_RANK_PLAYER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RANK_PLAYER", 0);
#endif

#ifdef ENABLE_PLAYER_RANKING
	PyModule_AddIntConstant(poModule, "ENABLE_PLAYER_RANKING", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PLAYER_RANKING", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_DAILY_BOSS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DAILY_BOSS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_QUICK_OPEN", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_QUICK_OPEN", 0);
#endif

#ifdef ENABLE_FAST_STACK
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_STACK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_STACK", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_DS_INVENTORY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_DS_INVENTORY", 0);
#endif
...
#if defined(__BL_MULTI_LANGUAGE__)
	PyModule_AddIntConstant(poModule, "__BL_MULTI_LANGUAGE__", 1);
#else
	PyModule_AddIntConstant(poModule, "__BL_MULTI_LANGUAGE__", 0);
#endif

#if defined(__BL_MULTI_LANGUAGE_PREMIUM__)
	PyModule_AddIntConstant(poModule, "__BL_MULTI_LANGUAGE_PREMIUM__", 1);
#else
	PyModule_AddIntConstant(poModule, "__BL_MULTI_LANGUAGE_PREMIUM__", 0);
#endif

#if defined(__BL_MULTI_LANGUAGE_ULTIMATE__)
	PyModule_AddIntConstant(poModule, "__BL_MULTI_LANGUAGE_ULTIMATE__", 1);
#else
	PyModule_AddIntConstant(poModule, "__BL_MULTI_LANGUAGE_ULTIMATE__", 0);
#endif

#if defined(ENABLE_GUILD_SAFEBOX)
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_SAFEBOX", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_SAFEBOX", 0);
#endif

#if defined(ENABLE_ALLOW_GUILD_SAFEBOX)
	PyModule_AddIntConstant(poModule, "ENABLE_ALLOW_GUILD_SAFEBOX", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ALLOW_GUILD_SAFEBOX", 0);
#endif

#if defined(ENABLE_GUILD_MEETING)
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_MEETING", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_MEETING", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EVENT_CALENDAR", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EVENT_CALENDAR", 0);
#endif

#ifdef ENABLE_BOOSTER_ITEMS
	PyModule_AddIntConstant(poModule, "ENABLE_BOOSTER_ITEMS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BOOSTER_ITEMS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_TRASH_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TRASH_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_FILEWATCHER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FILEWATCHER", 0);
#endif

#ifdef ENABLE_SYSERR_VIEWER
	PyModule_AddIntConstant(poModule, "ENABLE_SYSERR_VIEWER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SYSERR_VIEWER", 0);
#endif

#ifdef ENABLE_ITEM_TIME_EXTENDER
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_TIME_EXTENDER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_TIME_EXTENDER", 0);
#endif
}
