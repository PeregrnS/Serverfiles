...
PyObject* chrmgrRegisterSpecialTitle(PyObject* poSelf, PyObject* poArgs)
{
	int	iIndex;
	if (!PyTuple_GetInteger(poArgs, 0, &iIndex))
	{
	...
	int	iColor;
	if (!PyTuple_GetInteger(poArgs, 2, &iColor))
	{
		return Py_BadArgument();
	}

	CInstanceBase::RegisterSpecialTitle(iIndex, szTitleName, static_cast<DWORD>(iColor));
	return Py_BuildNone();
}
...
void initchrmgr()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "RegisterSpecialTitle", chrmgrRegisterSpecialTitle, METH_VARARGS },
	...
	PyModule_AddIntConstant(poModule, "SKILL_COSTUME_EFFECT_START", CInstanceBase::SKILL_COSTUME_EFFECT_START);
	PyModule_AddIntConstant(poModule, "SKILL_COSTUME_EFFECT_END", CInstanceBase::SKILL_COSTUME_EFFECT_END);
#endif
	...
	PyModule_AddIntConstant(poModule, "EFFECT_SELECT_PRIVATE_SHOP", CInstanceBase::EFFECT_SELECT_PRIVATE_SHOP);
#endif

#ifdef ENABLE_ATLASS_EXTENDED
	PyModule_AddIntConstant(poModule, "NAMECOLOR_BOSS", CInstanceBase::NAMECOLOR_BOSS);
	PyModule_AddIntConstant(poModule, "NAMECOLOR_STONES", CInstanceBase::NAMECOLOR_STONES);
#endif
