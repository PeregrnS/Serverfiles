...
void initeventmgr()
{
	...
	PyModule_AddIntConstant(poModule, "EVENT_TYPE_RUMI_EVENT",		InGameEventManager::EVENT_TYPE_RUMI_EVENT);
#endif
#ifdef ENABLE_MINI_GAME_FINDM
	PyModule_AddIntConstant(poModule, "EVENT_TYPE_MINI_GAME_FINDM",			InGameEventManager::EVENT_TYPE_MINI_GAME_FINDM);
#endif
