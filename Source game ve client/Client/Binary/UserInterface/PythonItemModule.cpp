...
#ifdef ENABLE_PREMIUM_PRIVATE_SHOP
		{ "GetItemByName",					itemGetItemByName,						METH_VARARGS },
		{ "GetItemListByName",				itemGetItemListByName,					METH_VARARGS },
#endif
...
/*#ifdef ENABLE_ITEM_MANAGER
	...
	PyModule_AddIntConstant(poModule, "WEAR_PET", CItemData::WEAR_PET);
#endif

#ifdef ENABLE_MOUNT_SYSTEM
	PyModule_AddIntConstant(poModule, "WEAR_MOUNT", CItemData::WEAR_MOUNT);
	PyModule_AddIntConstant(poModule, "COSTUME_SLOT_MOUNT", c_Costume_Slot_Mount);
	// PyModule_AddIntConstant(poModule, "APPLY_MOUNT", CItemData::APPLY_MOUNT);
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_MOUNT", CItemData::ITEM_TYPE_MOUNT);
#endif

	PyModule_AddIntConstant(poModule, "WEAR_COSTUME_BODY", CItemData::WEAR_COSTUME_BODY);
	PyModule_AddIntConstant(poModule, "WEAR_COSTUME_HAIR", CItemData::WEAR_COSTUME_HAIR);
#ifdef ENABLE_ACCE_COSTUME_SYSTEM
	PyModule_AddIntConstant(poModule, "WEAR_COSTUME_ACCE", CItemData::WEAR_COSTUME_ACCE);
#endif
#ifdef ENABLE_WEAPON_COSTUME_SYSTEM
	PyModule_AddIntConstant(poModule, "WEAR_COSTUME_WEAPON", CItemData::WEAR_COSTUME_WEAPON);
#endif
	...
	PyModule_AddIntConstant(poModule, "SHINING_SLOT_WEAPON1", c_Shining_Slot_Weapon1);
	PyModule_AddIntConstant(poModule, "SHINING_SLOT_WEAPON2", c_Shining_Slot_Weapon2);
	PyModule_AddIntConstant(poModule, "SHINING_SLOT_WEAPON3", c_Shining_Slot_Weapon3);
	PyModule_AddIntConstant(poModule, "SHINING_SLOT_BODY1", c_Shining_Slot_Body1);
	PyModule_AddIntConstant(poModule, "SHINING_SLOT_BODY2", c_Shining_Slot_Body2);
	PyModule_AddIntConstant(poModule, "SHINING_SLOT_SPECIAL", c_Shining_Slot_Special);
	...
	PyModule_AddIntConstant(poModule, "USE_CHANGE_ATTRIBUTE_DS",		CItemData::USE_CHANGE_ATTRIBUTE_DS);

#ifdef ENABLE_BOOSTER_ITEMS
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_BOOSTER", CItemData::ITEM_TYPE_BOOSTER);
	PyModule_AddIntConstant(poModule, "BOOSTER_SLOT_START", c_Booster_Slot_Start);
	PyModule_AddIntConstant(poModule, "BOOSTER_SLOT_WEAPON", c_Booster_Slot_Weapon);
	PyModule_AddIntConstant(poModule, "BOOSTER_SLOT_BODY", c_Booster_Slot_Body);
	PyModule_AddIntConstant(poModule, "BOOSTER_SLOT_HAIR", c_Booster_Slot_Hair);
	PyModule_AddIntConstant(poModule, "BOOSTER_SLOT_COUNT", c_Booster_Slot_Count);

	PyModule_AddIntConstant(poModule, "BOOSTER_WEAPON", CItemData::BOOSTER_WEAPON);
	PyModule_AddIntConstant(poModule, "BOOSTER_ARMOR", CItemData::BOOSTER_ARMOR);
	PyModule_AddIntConstant(poModule, "BOOSTER_HAIR", CItemData::BOOSTER_HAIR);
#endif
}
