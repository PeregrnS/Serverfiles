...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set(HEADER_GC_GUILDSTORAGE, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGuildStorage), DYNAMIC_SIZE_PACKET));

#ifdef __DAILY_QUESTS__
			Set(HEADER_GC_SEND_DAILY_QUESTS, TPacketType(sizeof(TPacketGCSendDailyQuests), DYNAMIC_SIZE_PACKET));
			Set(HEADER_GC_SEND_DAILY_REWARDS, TPacketType(sizeof(TPacketGCSendDailyRewards), DYNAMIC_SIZE_PACKET));
			Set(HEADER_GC_UPDATE_DAILY_QUESTS, TPacketType(sizeof(TPacketGCUpdateDailyQuest), STATIC_SIZE_PACKET));
			Set(HEADER_GC_UPDATE_DAILY_REWARDS, TPacketType(sizeof(TPacketGCUpdateDailyReward), STATIC_SIZE_PACKET));
#endif
			...
			Set(HEADER_GC_DROP_INFO, CNetworkPacketHeaderMap::TPacketType(sizeof(BYTE), STATIC_SIZE_PACKET));
#endif
			...
			Set(HEADER_GC_SKILL_GROUP_SELECT, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCSkillGroup), STATIC_SIZE_PACKET));
#endif
#ifdef ENABLE_PREMIUM_PRIVATE_SHOP
			Set(HEADER_GC_PRIVATE_SHOP, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCPrivateShop), DYNAMIC_SIZE_PACKET));
#endif
			...
			Set(HEADER_GC_UPDATE_COSTUME_VISIBILITY_STATUS, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCUpdateCostumeVisible), STATIC_SIZE_PACKET));
#endif
			...
			Set(HEADER_GC_ITEMSHOP, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCItemshopInfo), DYNAMIC_SIZE_PACKET/*STATIC_SIZE_PACKET*/));
#endif
#ifdef ENABLE_QUICK_OPEN
			#ifdef ENABLE_LARGE_DYNAMIC_PACKET
			Set(HEADER_GC_ITEM_BUFFERED, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCInventoryHeader), LARGE_DYNAMIC_SIZE_PACKET));
			#else
			Set(HEADER_GC_ITEM_BUFFERED, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCInventoryHeader), DYNAMIC_SIZE_PACKET));
			#endif
#endif
			Set(HEADER_GC_CHARACTER_DRAGON_POINTS, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCDragonPoints), STATIC_SIZE_PACKET));
			Set(HEADER_GC_CHARACTER_DRAGON_POINTS_CHANGE, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCDragonPointsChange), STATIC_SIZE_PACKET));
#ifdef ENABLE_GUILD_SAFEBOX
			Set(HEADER_GC_GUILD_SAFEBOX, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCGuildSafebox), DYNAMIC_SIZE_PACKET));
#endif
			...
			Set(HEADER_GC_TRASH, CNetworkPacketHeaderMap::TPacketType(sizeof(TTrashPacketGC), DYNAMIC_SIZE_PACKET));
#endif
		}
};
