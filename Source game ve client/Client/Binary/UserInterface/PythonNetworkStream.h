...
class CPythonNetworkStream : public CNetworkStream, public CSingleton<CPythonNetworkStream>
{
	...
	public:
		...
		bool SendShopBuyPacket(WORD bPos);
		bool SendShopSellPacket(WORD bySlot);
#ifdef ENABLE_EXTENDED_ITEM_COUNT
		bool SendShopSellPacketNew(WORD wSlot, short byCount);
#else
		...
		bool SendExchangeElkAddPacket(unsigned long long elk);
#else
	...
	protected:
		...
		bool RecvDailyQuests();
		bool RecvDailyRewards();
		bool RecvUpdateDailyQuests();
		bool RecvUpdateDailyRewards();
#endif
	...
	public:
		bool RecvSkillGroup();
		bool SendSkillGroupPacket(BYTE bGroup);
#endif
	...
	public:
		bool SendHwidBanPacket(BYTE bMode, const char* c_szPlayer, const char* c_szReason);
#endif
	...
	public:
		bool ChangeCostumeVisible(BYTE type, bool status);
		bool UpdateCostumeVisibleSettings();
#endif
	...
	public:
		bool SendSplitItemByCount(TItemPos Cell, short sCount);
#endif
	...
	protected:
		bool RecvBufferedInventoryPacket();
#endif
#ifdef ENABLE_FAST_STACK
	public:
		bool SendFastStackPacket(TItemPos itemPos);
#endif
#ifdef ENABLE_GUILD_SAFEBOX
	public:
		...
		bool SendGuildSafeboxGiveGoldPacket(DWORD dwGold);
		bool SendGuildSafeboxTakeGoldPacket(DWORD dwGold);
	protected:
		bool RecvGuildSafeboxPacket();
#endif
