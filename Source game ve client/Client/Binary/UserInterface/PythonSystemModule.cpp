...
//
PyObject* systemIsShowRainBow(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowRainBow());
}

PyObject* systemSetShowRainBowFlag(PyObject* poSelf, PyObject* poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowRainBowFlag(iFlag);

	return Py_BuildNone();
}

//
PyObject* systemSetShowTitleTextFlag(PyObject* poSelf, PyObject* poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowTitleTextFlag(iFlag);

	return Py_BuildNone();
}

PyObject* systemIsShowTitleText(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowTitleText());
}
...
PyObject* systemIsPreviewModel(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsPreviewModel());
}

PyObject* systemSetPreviewModel(PyObject* poSelf, PyObject* poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
	{
	...
	CPythonSystem::Instance().SetPreviewModel(iFlag);

	return Py_BuildNone();
}

PyObject* systemIsRenderRotation(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsRenderRotation());
}

PyObject* systemSetRenderRotation(PyObject* poSelf, PyObject* poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
	{
	...
	CPythonSystem::Instance().SetRenderRotation(iFlag);
...
void initsystemSetting()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "SetShowTitleTextFlag",		systemSetShowTitleTextFlag,		METH_VARARGS },
		{ "IsShowTitleText",			systemIsShowTitleText,			METH_VARARGS },

		{ "SetShowRainBowFlag",			systemSetShowRainBowFlag,		METH_VARARGS },
		{ "IsShowRainBow",				systemIsShowRainBow,				METH_VARARGS },
...
#ifdef ENABLE_RENDER_TARGET_PREVIEW
		{ "SetPreviewModel",			systemSetPreviewModel,			METH_VARARGS },
		{ "IsPreviewModel",				systemIsPreviewModel,			METH_VARARGS },

		{ "SetRenderRotation",			systemSetRenderRotation,		METH_VARARGS },
		{ "IsRenderRotation",			systemIsRenderRotation,			METH_VARARGS },
#endif
