...
PyObject * textTailHideItemTextTail(PyObject * poSelf, PyObject * poArgs)
{
	CPythonTextTail::Instance().HideItemTextTail();
	return Py_BuildNone();
}
...
void initTextTail()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "HideItemTextTail",			textTailHideItemTextTail,			METH_VARARGS },
