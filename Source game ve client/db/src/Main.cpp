...
#ifdef ENABLE_SKILL_COLOR_SYSTEM
	if (CConfig::instance().GetValue("SKILL_COLOR_CACHE_FLUSH_SECONDS", szBuf, 256))
	{
		str_to_number(g_iSkillColorCacheFlushSeconds, szBuf);
		sys_log(0, "SKILL_COLOR_CACHE_FLUSH_SECONDS: %d", g_iSkillColorCacheFlushSeconds);
	}
#endif
