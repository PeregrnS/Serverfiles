...
static const std::vector<std::string> arItemType = {
	...
	"ITEM_PASSIVE",					//39
	"ITEM_MOUNT",					//40
	"ITEM_SHINING", 				// ENABLE_SHINING_ITEM_SYSTEM
	"ITEM_BOOSTER"					// ENABLE_BOOSTER_ITEMS
...
static const std::unordered_map<uint32_t, std::vector<std::string>> mapItemSubType {
	...
	{3,		{ "USE_POTION", "USE_TALISMAN", "USE_TUNING", "USE_MOVE", "USE_TREASURE_BOX", "USE_MONEYBAG", "USE_BAIT",
			...
			"USE_CHANGE_COSTUME_ATTR", "USE_RESET_COSTUME_ATTR", "USE_ADD_PENDANT_ATTRIBUTE", "USE_ADD_PENDANT_FIVE_ATTRIBUTE", "USE_CHANGE_PENDANT_ATTRIBUTE", "USE_CHANGE_ATTRIBUTE_DS", "USE_AVERAGE_DAMAGE_UP", "USE_TITLE"}},
	...
	{28,	{ "COSTUME_BODY", "COSTUME_HAIR", "COSTUME_ACCE", "COSTUME_WEAPON"}},
	...
	{40,	{ "MOUNT_SEAL", "MOUNT_OVERLAY"}},
	//#endif
	// #ifdef ENABLE_SHINING_ITEM_SYSTEM
	{41,	{ "SHINING_WEAPON", "SHINING_ARMOR", "SHINING_SPECIAL"}},
	// #endif
	// #ifdef ENABLE_BOOSTER_ITEMS
	{42,	{ "BOOSTER_WEAPON", "BOOSTER_ARMOR", "BOOSTER_HAIR"}},
	// #endif
	
	// #ifdef __SKILL_COSTUME__
	{ITEM_SKILL_COSTUME, { "SKILL_COSTUME_1", "SKILL_COSTUME_2", "SKILL_COSTUME_3", "SKILL_COSTUME_4", "SKILL_COSTUME_5", "SKILL_COSTUME_6"}},
	// #endif
};
...
int get_Item_ApplyType_Value(string inputString)
{
	...
	string arApplyType[] = {"APPLY_NONE", "APPLY_MAX_HP", "APPLY_MAX_SP", "APPLY_CON", "APPLY_INT", "APPLY_STR", "APPLY_DEX", "APPLY_ATT_SPEED",
			...
			"APPLY_RESIST_MOUNT_FALL", "APPLY_MOUNT", // 116-118
			"APPLY_ATTBONUS_STONE", // ENABLE_EXTENDED_ATTRS
			"APPLY_ATTBONUS_BOSS",
