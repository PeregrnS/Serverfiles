...
public:
	...
	bool	DoRefineGrade(LPCHARACTER ch, TItemPos(&aItemPoses)[DRAGON_SOUL_REFINE_GRID_SIZE], bool returnTrueInCaseOfFailedRefine = false);
	bool	DoAllRefineGrade(LPCHARACTER ch, BYTE dsKind, BYTE dsGrade);
#else
	...
	bool	ChangeAttributeDragonSoul(LPITEM pDS);
