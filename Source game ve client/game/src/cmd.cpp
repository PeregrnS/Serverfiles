...
struct command_info cmd_info[] =
{
	...
	{ "item",		do_item,		0,			POS_DEAD,	GM_WIZARD		},

	{ "mob",		do_mob,			0,			POS_DEAD,	GM_LOW_WIZARD	},
	{ "mob_ld",		do_mob_ld,			0,			POS_DEAD,	GM_LOW_WIZARD	},
	...
	{ "kill",		do_kill,		0,			POS_DEAD,	GM_LOW_WIZARD	},
	{ "ipurge",		do_item_purge,		0,			POS_DEAD,	GM_LOW_WIZARD	},
	{ "group",		do_group,		0,			POS_DEAD,	GM_WIZARD	},
	{ "grrandom",	do_group_random,	0,			POS_DEAD,	GM_IMPLEMENTOR	},

	{ "set",		do_set,			0,			POS_DEAD,	GM_HIGH_WIZARD	},
...
#ifdef ENABLE_TELEPORT_GUILD
	{ "teleport_guild",				do_teleport_guild,		0,	POS_DEAD,	GM_PLAYER	},
	{ "answer_teleport_guild",				do_teleport_guild_answer,		0,	POS_DEAD,	GM_PLAYER	},
#endif
...
#ifdef ENABLE_TELEPORT_PM
	{ "answer_warp_at_character",				do_answer_warp_at_character,			0,					POS_DEAD,		GM_PLAYER},
	{ "request_warp_at_character",				do_request_warp_at_character,			0,					POS_DEAD,		GM_PLAYER},
#endif
	...
	{"player_remove_affect", do_player_remove_affect, 0, POS_DEAD, GM_PLAYER},
#endif
#ifdef ENABLE_RENEWAL_ADD_STATS
	{"stat_val", do_stat_val, 0, POS_DEAD, GM_PLAYER},
#endif
#ifdef ENABLE_SAVE_BLOCK_ATTR
	{ "save_block_attr",	do_save_block_attr,		0,		POS_DEAD,	GM_PLAYER },
#endif
#ifdef RENEWAL_PICKUP_AFFECT
	{ "pickup_affect",	do_pickup_affect,		0,		POS_DEAD,	GM_PLAYER },
#endif
#ifdef __PREMIUM_PRIVATE_SHOP__
	{ "open_search",	do_open_search_shop,		0,		POS_DEAD,	GM_PLAYER },
#endif
#ifdef ENABLE_HWID_BAN
...
#endif
	// { "quickopen",	do_quick_open,		0,		POS_DEAD,	GM_PLAYER },
#ifdef ENABLE_QUICK_OPEN
...
#endif
#ifdef __SPIN_WHEEL_BOSS__
	{ "spin_wheel_boss",	do_spin_wheel_boss,		0,		POS_DEAD,	GM_PLAYER },
#endif
#ifdef ENABLE_GLOBAL_REWARD
	{ "reward_system",	do_reward_system,		0,		POS_DEAD,	GM_PLAYER },
#endif
#ifdef ENABLE_ANTI_MULTIPLE_FARM
	{ "anti_farm_info", do_debug_anti_multiple_farm,	0, POS_DEAD, GM_PLAYER	},
#endif
#ifdef ENABLE_VOTE_4_BUFF
	{ "vote4buff", 		do_vote4buff,		0,		POS_DEAD, GM_PLAYER },
#endif
#ifdef ENABLE_RANK_PLAYER
...
#endif
#ifdef __GUILD_SAFEBOX__
	{ "guild_safebox_close", do_guild_safebox_close, 0, POS_DEAD, GM_PLAYER },
#endif
#ifdef ENABLE_EVENT_CALENDAR
	{ "event_manager",	do_event_manager, 0, POS_DEAD,	GM_PLAYER },
	// { "teleport_event_map_event", do_teleport_map_event, 0, POS_DEAD, GM_PLAYER },
#endif
	{ "skip_battlepass_mission",	do_skip_battlepass_mission, 0, POS_DEAD,	GM_PLAYER },
#ifdef ENABLE_REWARD_SYSTEM
	{ "update_reward_data",	do_update_reward_data,		0,		POS_DEAD,	GM_PLAYER },
#endif
#ifdef ENABLE_GUILD_MEETING
	{ "guild_meeting", do_guild_meeting, 0, POS_DEAD, GM_PLAYER },
	{ "guild_meeting_yes", do_guild_meeting_yes, 0, POS_DEAD, GM_PLAYER },
#endif
#ifdef ENABLE_CAPTCHA
	{ "captcha",				do_captcha,					0,				POS_DEAD,		GM_GOD },
#endif

	{ "open_gs",				do_open_gs,				0,	POS_DEAD,	GM_PLAYER	},
	{ "block_player",				do_block,				0,	POS_DEAD,	GM_HIGH_WIZARD	},

#ifdef __DAILY_QUESTS__
	{ "claim_daily", do_claim_daily,		0,		POS_DEAD,	GM_PLAYER },
#endif
