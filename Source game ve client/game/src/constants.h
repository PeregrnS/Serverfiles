...
extern const DWORD THuntingRandomItem_01_5[6][2];
extern const DWORD THuntingRandomItem_6_10[13][2];
extern const DWORD THuntingRandomItem_11_15[13][2];
extern const DWORD THuntingRandomItem_16_22[13][2];
extern const DWORD THuntingRandomItem_23_28[13][2];
#endif

#ifdef ENABLE_TRASH_SYSTEM
extern std::set<uint32_t> g_setTrashDisablesItems;
#endif
