...
class CEntity
{
	...
	public:
		...
		long			GetXLast() const { return m_posLast.x; }
		long			GetYLast() const { return m_posLast.y; }
		long			GetZLast() const { return m_posLast.z; }
		void			SetXYZLast(long x, long y, long z) { m_posLast.x = x, m_posLast.y = y, m_posLast.z = z; }
#endif
