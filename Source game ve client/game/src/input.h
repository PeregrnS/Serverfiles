...
extern void SendShout(const char * szText, BYTE bEmpire
	...
	, const char* szCountry, int hyperlinks
#endif
);
...
class CInputMain : public CInputProcessor
{
	...
	protected:
		...
		void		SkillGroup(LPCHARACTER ch, const char *c_pData);
#endif
		...
		void 		HWIDManager(LPCHARACTER ch, const char* data);
#endif
		...
		void		ChangeCostumeVisibilityStatus(LPCHARACTER ch, const char * c_pData);
#endif
#ifdef ENABLE_ANTI_MULTIPLE_FARM
		int		RecvAntiFarmUpdateStatus(LPCHARACTER ch, const char* c_pData, size_t uiBytes);
#endif
#ifdef ENABLE_SPLIT_BY_COUNT
		void	SendSplitItemByCount(LPCHARACTER ch, const char* c_pData);
#endif
		...
		void		GuildSafebox(LPCHARACTER ch, BYTE header, const char* c_pData);
#endif
#ifdef ENABLE_TRASH_SYSTEM
		int			RecvTrashPacket(LPCHARACTER ch, const char* data);
#endif
...
#endif
#ifdef __GUILD_SAFEBOX__
	void	GuildSafebox(BYTE bHeader, DWORD dwHandle, const char* c_pData);
#endif
...
class CInputP2P : public CInputProcessor
{
	...
	public:
		...
		void		RequestWarp(const char* c_pData);
		...
		void		MaintenanceInfo(const char* c_pData);
#endif
#ifdef ENABLE_ANTI_MULTIPLE_FARM
		void		RecvAntiFarmUpdateStatus(LPDESC d, const char* c_pData);
#endif
#ifdef ENABLE_RANK_PLAYER
		void		PlayerRank(LPDESC d, const char* c_pData);
#endif
		...
		void 		GuildTeleport(LPDESC d, const char* c_pData);
#endif
