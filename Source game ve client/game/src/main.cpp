...
#ifdef ENABLE_SVSIDE_PROTECTION
	#include <dlfcn.h>
#endif
...
int main(int argc, char **argv)
{
	...
	GuildStorageManager guild_storage_manager;
	...
	DSManager dsManager;
#ifdef __DAILY_QUESTS__
	CDailyQuestManager	dailyquest_manager;
#endif
#ifdef ENABLE_SWITCHBOT_SYSTEM
...
#endif
#ifdef __ENABLE_BIOLOG_SYSTEM__
	CBiologSystemManager biolog_manager;
#endif
#ifdef __PREMIUM_PRIVATE_SHOP__
...
#endif
#ifdef ENABLE_RANK_PLAYER
		RankPlayer::instance().Initialize();
#endif
#ifdef __RANKING_SYSTEM__
		rankplayer.Initialize();
#endif
#ifdef ENABLE_AUTO_EVENTS
		EventManager.Initialize();
#endif
#ifdef ENABLE_DAILY_BOSS
		CDailyBoss::instance().Initialize();
#endif
	}
	...
	GuildStorageManager::Instance().Initialize();
...
#ifdef __RANKING_SYSTEM__
	sys_log(0, "<shutdown> Destroying RankPlayer...");
	rankplayer.Destroy();
#endif
...
#ifdef __PREMIUM_PRIVATE_SHOP__
	sys_log(0, "<shutdown> Destroying CPrivateShopManager...");
	private_shop_manager.Destroy();
#endif
...
#ifdef __DAILY_QUESTS__
	CDailyQuestManager::instance().Update(thecore_heart->pulse);
#endif
