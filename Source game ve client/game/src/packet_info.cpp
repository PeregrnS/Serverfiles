...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_GUILDSTORAGE, sizeof(TPacketGuildStorage), "GuildStorage", false);
	
#ifdef ENABLE_ACCE_COSTUME_SYSTEM
	Set(HEADER_CG_ACCE, sizeof(TPacketAcce), "Acce", true);
#endif
#ifdef ENABLE_SWITCHBOT_SYSTEM
	Set(HEADER_CG_SWITCHBOT, sizeof(TPacketGCSwitchbot), "Switchbot", false);
#endif
#ifdef ENABLE_DROP_INFO
	Set(HEADER_CG_DROP_INFO, sizeof(/*TODO*/ BYTE), "DropInfo", true);
#endif
	...
	Set(HEADER_CG_SKILL_GROUP_SELECT, sizeof(TPacketCGSkillGroup), "SkillGroup", true);
#endif
#ifdef ENABLE_INGAME_WIKI
	...
	Set(HEADER_CG_SKILL_COLOR, sizeof(TPacketCGSkillColor), "ChangeSkillColor", false);
#endif
#ifdef ENABLE_HIDE_COSTUME_SYSTEM
	Set(HEADER_CG_CHANGE_COSTUME_VISIBILITY_STATUS, sizeof(TPacketCGChangeCostumeVisibilityStatus), "ChangeCostumeVisibilityStatus", false);
#endif
#ifdef ENABLE_ANTI_MULTIPLE_FARM
	Set(HEADER_CG_ANTI_FARM, sizeof(TSendAntiFarmInfo), "RecvAntiFarmUpdateStatus", false);
#endif
#ifdef ENABLE_SPLIT_BY_COUNT
	Set(HEADER_CG_SPLIT_ITEM, sizeof(TSplitItemByCount), "SendSplitItemByCount", false);
#endif
	...
	Set(HEADER_CG_FAST_STACK, sizeof(TPacketCGFastStack), "FastStack", true);
#endif
#ifdef __GUILD_SAFEBOX__
	Set(HEADER_CG_GUILD_SAFEBOX_OPEN, sizeof(BYTE), "GuildSafeboxOpen", true);
	Set(HEADER_CG_GUILD_SAFEBOX_CHECKIN, sizeof(TPacketCGGuildSafeboxCheckin), "GuildSafeboxCheckin", true);
	Set(HEADER_CG_GUILD_SAFEBOX_CHECKOUT, sizeof(TPacketCGGuildSafeboxCheckout), "GuildSafeboxCheckout", true);
	Set(HEADER_CG_GUILD_SAFEBOX_ITEM_MOVE, sizeof(TPacketCGItemMove), "GuildSafeboxItemMove", true);
	Set(HEADER_CG_GUILD_SAFEBOX_GIVE_GOLD, sizeof(TPacketCGGuildSafeboxGold), "GuildSafeboxGiveGold", true);
	Set(HEADER_CG_GUILD_SAFEBOX_GET_GOLD, sizeof(TPacketCGGuildSafeboxGold), "GuildSafeboxTakeGold", true);
#endif
#ifdef ENABLE_TRASH_SYSTEM
	Set(HEADER_CG_TRASH, sizeof(TTrashPacketCG), "TrashSystem", true);
#endif
...
CPacketInfoGG::CPacketInfoGG()
{
...
#endif
#ifdef __PREMIUM_PRIVATE_SHOP__
	Set(HEADER_GG_PRIVATE_SHOP_ITEM_SEARCH_UPDATE, sizeof(TPacketGGPrivateShopItemSearchUpdate), "PrivateShopItemSearchUpdate", false);
...
#endif
#ifdef ENABLE_ANTI_MULTIPLE_FARM
	Set(HEADER_GG_ANTI_FARM, sizeof(CAntiMultipleFarm::TP2PChangeDropStatus), "RecvAntiFarmUpdateStatus", false);
#endif
	...
	Set(HEADER_GG_GUILD_TELEPORT, sizeof(TPacketGGGuildTeleport), "GuildTeleport", false);
#endif
#ifdef ENABLE_TELEPORT_PM
	Set(HEADER_GG_REQUEST_WARP, sizeof(TPacketGGRequestWarp), "RequestWarp", false);
#endif
}
