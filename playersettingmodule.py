...
def __InitData():
	...
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_RAMADAN_RING_EQUIP, "", "d:/ymir work/effect/law_ringeffect/law_ringeffect.mse")
	...
	if app.ENABLE_PREMIUM_PRIVATE_SHOP:
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_SELECT_PRIVATE_SHOP, "", "d:/ymir work/effect/etc/direction/direction_land2.mse")
...
def __LoadGameEffect():
	...
	if app.ENABLE_BUFF_ITEMS_SYSTEM:
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_RESIST_BUFF, "", "d:/ymir work/my_work/effect/resistbuff.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_CRITICAL_BUFF, "Bip01 R Hand", "d:/ymir work/my_work/effect/criticalbuff.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_REFLECT_BUFF, "", "d:/ymir work/my_work/effect/reflectbuff.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_MOV_SPEED_BUFF, "", "d:/ymir work/pc/shaman/effect/10kwaesok_loop.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_ATT_GRADE_BUFF, "Bip01 L Hand", "d:/ymir work/pc/shaman/effect/jeungryeok_hand.mse")
	...
	if app.ENABLE_SHINING_ITEM_SYSTEM:
		...
		chrmgr.RegisterEffect(chrmgr.EFFECT_SHINING_ARMOR+0, "Bip01", "D:/ymir work/effect/mehok/shining/dragon_green_max/armor.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_SHINING_SPECIAL+0, "Bip01", "D:/ymir work/effect/alune_black_friday/black_eff.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+12, "", EmoticonStr+"vip5.mse")
	net.RegisterEmoticonString("(vIpSyStEmMeTiN2@Tupeu1X3SATxUxPxExU)")
	
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+13, "", EmoticonStr+"mister5.mse")
	net.RegisterEmoticonString("(vIpSyStEmMeTiN2@Tupeu11X3SATxUxPxExUMister)")
	
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+14, "", EmoticonStr+"miss5.mse")
	net.RegisterEmoticonString("(vIpSyStEmMeTiN2@Tupeu11X3SATxUxPxExUMiss)")
	
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+15, "", EmoticonStr+"moderator5.mse")
...
if app.ENABLE_SKILL_COSTUME_SYSTEM:
	def LoadNewSkills():
		for x in range(1, app.SKILL_COSTUME_EFFECT_COUNT + 1):
			#Warrior
			__LoadNewWarriorSkillsEx(RACE_WARRIOR_M, "d:/ymir work/pc/warrior/", x)
			__LoadNewWarriorSkillsEx(RACE_WARRIOR_W, "d:/ymir work/pc2/warrior/", x)
			#Assassin
			__LoadNewAssassinSkillsEx(RACE_ASSASSIN_W, "d:/ymir work/pc/assassin/", x)
			__LoadNewAssassinSkillsEx(RACE_ASSASSIN_M, "d:/ymir work/pc2/assassin/", x)
			#Sura
			__LoadNewSuraSkillsEx(RACE_SURA_M, "d:/ymir work/pc/sura/", x)
			__LoadNewSuraSkillsEx(RACE_SURA_W, "d:/ymir work/pc2/sura/", x)
			#Shaman
			__LoadNewShamanSkillsEx(RACE_SHAMAN_W, "d:/ymir work/pc/shaman/", x)
			__LoadNewShamanSkillsEx(RACE_SHAMAN_M, "d:/ymir work/pc2/shaman/", x)
			#Loop Data
			__RegisterLoopData(x)
		
	def __RegisterLoopData(loadSkillCount):
		END_STRING = "_%d" % (loadSkillCount)
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+16+(100*(loadSkillCount-1)), "", "d:/ymir work/pc/warrior/skill" +END_STRING+ "/gyeokgongjang_loop.mse")
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+17+(100*(loadSkillCount-1)), "", "d:/ymir work/pc/assassin/skill" +END_STRING+ "/gyeonggong_loop.mse")  
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+19+(100*(loadSkillCount-1)), "Bip01 R Finger2", "d:/ymir work/pc/sura/skill" +END_STRING+ "/gwigeom_loop.mse")
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+20+(100*(loadSkillCount-1)), "", "d:/ymir work/pc/sura/skill" +END_STRING+ "/fear_loop.mse")  
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+21+(100*(loadSkillCount-1)), "", "d:/ymir work/pc/sura/skill" +END_STRING+ "/jumagap_loop.mse") 
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+22+(100*(loadSkillCount-1)), "", "d:/ymir work/pc/shaman/skill" +END_STRING+ "/3hosin_loop.mse")  
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+23+(100*(loadSkillCount-1)), "", "d:/ymir work/pc/shaman/skill" +END_STRING+ "/boho_loop.mse") 
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+24+(100*(loadSkillCount-1)), "", "d:/ymir work/pc/shaman/skill" +END_STRING+ "/10kwaesok_loop.mse") 
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+25+(100*(loadSkillCount-1)), "", "d:/ymir work/pc/sura/skill" +END_STRING+ "/heuksin_loop.mse")
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+26+(100*(loadSkillCount-1)), "", "d:/ymir work/pc/sura/skill" +END_STRING+ "/muyeong_loop.mse")
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+28+(100*(loadSkillCount-1)), "Bip01", "d:/ymir work/skill" +END_STRING+ "/hit/blow_flame/flame_loop.mse")
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+29+(100*(loadSkillCount-1)), "Bip01 R Hand", "d:/ymir work/pc/shaman/skill" +END_STRING+ "/6gicheon_hand.mse")
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+30+(100*(loadSkillCount-1)), "Bip01 L Hand", "d:/ymir work/pc/shaman/skill" +END_STRING+ "/jeungryeok_hand.mse")
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+32+(100*(loadSkillCount-1)), "Bip01 Head", "d:/ymir work/pc/sura/skill" +END_STRING+ "/pabeop_loop.mse")
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_AFFECT+33+(100*(loadSkillCount-1)), "", "d:/ymir work/pc/warrior/skill" +END_STRING+ "/gyeokgongjang_loop.mse") 
		
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_WEAPON+1+(100*(loadSkillCount-1)), "equip_right_hand", "d:/ymir work/pc/warrior/skill" +END_STRING+ "/geom_sword_loop.mse")
		chrmgr.RegisterEffect(chrmgr.SKILL_COSTUME_EFFECT_START+chrmgr.EFFECT_WEAPON+2+(100*(loadSkillCount-1)), "equip_right_hand", "d:/ymir work/pc/warrior/skill" +END_STRING+ "/geom_spear_loop.mse")
		
	def __LoadNewWarriorSkillsEx(race, path, loadSkillCount):
		## Warrior
		#########################################################################################
		chrmgr.SelectRace(race)
		## SKILL
		END_STRING = "_%d/" % (loadSkillCount)
		chrmgr.SetPathName(path + "skill" + END_STRING)
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+1)+(100*(loadSkillCount-1)), "samyeon_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+2)+(100*(loadSkillCount-1)), "palbang_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+3)+(100*(loadSkillCount-1)), "jeongwi_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+4)+(100*(loadSkillCount-1)), "geomgyeong_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+5)+(100*(loadSkillCount-1)), "tanhwan_4.msa")
		
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+16)+(100*(loadSkillCount-1)), "gigongcham_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+17)+(100*(loadSkillCount-1)), "gyeoksan_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+18)+(100*(loadSkillCount-1)), "daejin_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+19)+(100*(loadSkillCount-1)), "cheongeun_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+20)+(100*(loadSkillCount-1)), "geompung_4.msa")
		
	def __LoadNewAssassinSkillsEx(race, path, loadSkillCount):
		## Assassin
		#########################################################################################
		chrmgr.SelectRace(race)
		## SKILL
		...
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+1)+(100*(loadSkillCount-1)), "amseup_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+2)+(100*(loadSkillCount-1)), "gungsin_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+3)+(100*(loadSkillCount-1)), "charyun_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+4)+(100*(loadSkillCount-1)), "eunhyeong_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+5)+(100*(loadSkillCount-1)), "sangong_4.msa")
		
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+16)+(100*(loadSkillCount-1)), "yeonsa_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+17)+(100*(loadSkillCount-1)), "gwangyeok_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+18)+(100*(loadSkillCount-1)), "hwajo_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+19)+(100*(loadSkillCount-1)), "gyeonggong_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+20)+(100*(loadSkillCount-1)), "dokgigung_4.msa")
			
			
	def __LoadNewSuraSkillsEx(race, path, loadSkillCount):
		## Sura
		#########################################################################################
		chrmgr.SelectRace(race)
		END_STRING = "_%d/" % (loadSkillCount)
		...
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+1)+(100*(loadSkillCount-1)), "swaeryeong_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+2)+(100*(loadSkillCount-1)), "yonggwon_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+3)+(100*(loadSkillCount-1)), "gwigeom_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+4)+(100*(loadSkillCount-1)), "gongpo_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+5)+(100*(loadSkillCount-1)), "jumagap_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+6)+(100*(loadSkillCount-1)), "pabeop_4.msa")
		
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+16)+(100*(loadSkillCount-1)), "maryeong_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+17)+(100*(loadSkillCount-1)), "hwayeom_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+18)+(100*(loadSkillCount-1)), "muyeong_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+19)+(100*(loadSkillCount-1)), "heuksin_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+20)+(100*(loadSkillCount-1)), "tusok_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+21)+(100*(loadSkillCount-1)), "mahwan_4.msa")


	def __LoadNewShamanSkillsEx(race, path, loadSkillCount):
		## Shaman
		#########################################################################################
		chrmgr.SelectRace(race)
		END_STRING = "_%d/" % (loadSkillCount)
		chrmgr.SetPathName(path + "skill" + END_STRING)
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+1)+(100*(loadSkillCount-1)),	"bipabu_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+2)+(100*(loadSkillCount-1)),	"yongpa_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+3)+(100*(loadSkillCount-1)),	"paeryong_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+4)+(100*(loadSkillCount-1)),	"hosin_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+5)+(100*(loadSkillCount-1)),	"boho_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+6)+(100*(loadSkillCount-1)),	"gicheon_4.msa")
		
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+16)+(100*(loadSkillCount-1)), "noejeon_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+17)+(100*(loadSkillCount-1)), "byeorak_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+18)+(100*(loadSkillCount-1)), "pokroe_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+19)+(100*(loadSkillCount-1)), "jeongeop_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+20)+(100*(loadSkillCount-1)), "kwaesok_4.msa")
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, (chr.MOTION_SKILL_COSTUME+21)+(100*(loadSkillCount-1)), "jeungryeok_4.msa")
