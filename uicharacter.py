...
FACE_IMAGE_DICT = {
	playersettingmodule.RACE_WARRIOR_M	: "d:/ymir work/ui/character/face/0.png",
	playersettingmodule.RACE_WARRIOR_W	: "d:/ymir work/ui/character/face/4.png",
	playersettingmodule.RACE_ASSASSIN_M	: "d:/ymir work/ui/character/face/5.png",
	playersettingmodule.RACE_ASSASSIN_W	: "d:/ymir work/ui/character/face/1.png",
	playersettingmodule.RACE_SURA_M		: "d:/ymir work/ui/character/face/2.png",
	playersettingmodule.RACE_SURA_W		: "d:/ymir work/ui/character/face/6.png",
	playersettingmodule.RACE_SHAMAN_M	: "d:/ymir work/ui/character/face/7.png",
	playersettingmodule.RACE_SHAMAN_W	: "d:/ymir work/ui/character/face/3.png"
}
...
class CharacterWindow(ui.ScriptWindow):
	...
	def __BindObject(self):
		...
		if app.ENABLE_DETAILS_UI:
			...
			self.ExpandBtn = ui.MakeButton(MainBoard, 240, 120, "", "d:/ymir work/ui/game/chardetails/", "btn_minimize_normal.tga", "btn_minimize_over.tga", "btn_minimize_down.tga")
			self.ExpandBtn.SetEvent(ui.__mem_func__(self.__ClickExpandButton))
			self.MinimizeBtn = ui.MakeButton(MainBoard, 240, 120, "", "d:/ymir work/ui/game/chardetails/", "btn_expand_normal.tga", "btn_expand_over.tga", "btn_expand_down.tga")
	...
	def __RefreshStatusPlusButtonList(self):
		...
		if statusPlusPoint>0:
			...
			self.statusPlusValue.SetPackedFontColor(0xff4CFF00)
		else:
			self.statusPlusValue.SetText(str(0))
			# self.statusPlusLabel.Hide()
			self.HideStatusPlusButtonList()
			self.statusPlusValue.SetPackedFontColor(0xffFF0000)
	...
	def __OverInStatButton(self, stat):
		try:
			if app.ENABLE_RENEWAL_ADD_STATS:
				self.__ShowStatToolTip(self.STAT_DESCRIPTION[stat], localeInfo.TOOLTIP_INFO_QUICK_STATS)
			else:
	...
	if app.ENABLE_RENEWAL_ADD_STATS:
		def __ShowStatToolTip(self, statDesc, statDesc2 = ""):
			SPECIAL_COLOR_TEXT = grp.GenerateColor(1.0,1.0,0.5,1.0)
			self.toolTip.ClearToolTip()
			self.toolTip.AppendTextLine(statDesc)
			if statDesc2:
				self.toolTip.AppendSpace(5)
				self.toolTip.AppendTextLine(statDesc2, SPECIAL_COLOR_TEXT)
			self.toolTip.Show()
	else:
	...
	def RefreshSkillPlusPointLabel(self):
		...
		if activeStatPoint == 0:
			self.activeSkillPointValue.SetPackedFontColor(0xffFF0000)
		else:
			self.activeSkillPointValue.SetPackedFontColor(0xff4CFF00)
			
		if supportStatPoint == 0:
			self.supportSkillPointValue.SetPackedFontColor(0xffFF0000)
		else:
			self.supportSkillPointValue.SetPackedFontColor(0xff4CFF00)
