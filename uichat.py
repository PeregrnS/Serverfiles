...
if app.ENABLE_CHATTING_WINDOW_RENEWAL or app.__BL_MULTI_LANGUAGE_ULTIMATE__:
...
class ChatLine(ui.EditLine):
	...
	def __SendShoutChatPacket(self, text):
		...
		if app.PM_IN_GLOBAL_CHAT:
			self.__SendChatPacket(constInfo.PM_LINK + '|cfff000ff|HPM_LINK:' + str(player.GetName()) + '|h[PM]|h|r ' + text[1:], chat.CHAT_TYPE_SHOUT)
		else:
...
class ChatWindow(ui.Window):
	...
	def HideShit(self):
		self.flag_bar.Hide()
		self.btnChatTab.Hide()
		self.btnChatSettingOption.Hide()
