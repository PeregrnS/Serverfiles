...
events_default_data = {
    ...
    # player.BATTLEROYALE:["empire_war_event","Battle-Royale"],
}
...
class ImageBoxSpecial(ui.ImageBox):
    ...
    def __init__(self, isMiniIcon = False):
        ...
        if isMiniIcon:
            ...
            #self.SetSize(90, 90)
            (x,y) = (wndMgr.GetScreenWidth()-300, 5)
...
class EventCalendarWindow(ui.BoardWithFinalCoreTitleBar3):
    def __del__(self):
        ui.BoardWithFinalCoreTitleBar33.__del__(self)
    def Destroy(self):
        self.children = {}
        self.currentMonth =0
        self.currentYear = 0
    def __init__(self):
        ui.BoardWithFinalCoreTitleBar3.__init__(self)
        self.Destroy()
        self.__LoadWindow()
    ...
    def OnClick(self, eventIndex):
        ...
        # elif eventIndex == player.BATTLEROYALE:
            # interface.ClickBattleRoyaleEventButton()
