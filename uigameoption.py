...
class OptionDialog(ui.ScriptWindow):
	...
	def __Initialize(self):
		...
		if app.ENABLE_RENDER_TARGET_PREVIEW:
			self.showPreviewModelButtonList = []
	...
	def __Load_BindObject(self):
		try:
			...
			self.blockButtonList.append(GetObject("block_view_equip_button"))
			...
			if app.ENABLE_RENDER_TARGET_PREVIEW:
				self.showPreviewModelButtonList.append(GetObject("preview_model_on_button"))
				self.showPreviewModelButtonList.append(GetObject("preview_model_off_button"))
	...
	def __Load(self):
		...
		self.blockButtonList[6].SetToggleUpEvent(self.__OnClickBlockViewEquip)
		...
		self.blockButtonList[6].SetToggleDownEvent(self.__OnClickBlockViewEquip)
		...
		if app.ENABLE_RENDER_TARGET_PREVIEW:
			self.showPreviewModelButtonList[0].SAFE_SetEvent(self.__OnClickShowPreviewModelOnButton)
			self.showPreviewModelButtonList[1].SAFE_SetEvent(self.__OnClickShowPreviewModelOffButton)
	...
	if app.ENABLE_RENDER_TARGET_PREVIEW:
		def __OnClickShowPreviewModelOnButton(self):
			systemSetting.SetPreviewModel(True)
			self.RefreshPreviewModel()

		def __OnClickShowPreviewModelOffButton(self):
			systemSetting.SetPreviewModel(False)
			self.RefreshPreviewModel()
	...
	if app.ENABLE_RENDER_TARGET_PREVIEW:
		def RefreshPreviewModel(self):
			if systemSetting.IsPreviewModel():
				self.showPreviewModelButtonList[0].Down()
				self.showPreviewModelButtonList[1].SetUp()
			else:
				self.showPreviewModelButtonList[0].SetUp()
				self.showPreviewModelButtonList[1].Down()
