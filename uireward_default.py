...
global_reward_info = {
	0 : {
		"type": player.REWARD_MISSION_DUNGEON,
		"subValue": 2,
		"icon_name" : "zodiac_dungeon",
	...
	2 : {
		...
		"subValue": 55,
		"icon_name" : "average_55",
		"reward_items" : [ [31111, 1] ],
	},
	3 : {
		"type": player.REWARD_MISSION_CUSTOM_SASH,
		"subValue": 25,
		"icon_name" : "sash_25",
		"reward_items" : [ [31111, 1] ],
	},
	...
	7 : {
		"type": player.REWARD_MISSION_LEVEL_UP_PET,
		"subValue": 115,
		"icon_name" : "pet_lv_115",
		"reward_items" : [ [31111, 1] ],
	},
	8 : {
		"type": player.REWARD_MISSION_DUNGEON,
		"subValue": 1,
		"icon_name" : "hydra_dungeon",
		"reward_items" : [ [31111, 1] ],
	},
	9 : {
		"type": player.REWARD_MISSION_DUNGEON,
		"subValue": 2,
		"icon_name" : "meley_dungeon",
		"reward_items" : [ [31111, 1] ],
	},
	10 : {
		"type": player.REWARD_MISSION_SKILL_UPGRADE,
		"subValue": 40,
		"icon_name" : "perfect_master",
		"reward_items" : [ [31111, 1] ],
	},
	11 : {
		"type": player.REWARD_MISSION_FIRST_ITEM,
	...
	16 : {
		"type": player.REWARD_MISSION_INVENTORY_SLOT,
		"subValue": 40,
		"icon_name" : "inventory_slot",
		"reward_items" : [ [31111, 1] ],
	},
}
...
solo_reward_info = {
	...
	13 : {
		...
		"max_value": 100,
		"level_difference" : 0,
		"icon_name" : "meley_chest",
		"reward_items" : [ [31111, 1] ],
	},
	14 : {
		"type": player.REWARD_MISSION_COMPLETE_SKILL,
		"subValue": 0,
		"max_value": 1,
		"level_difference" : 0,
	...
	19 : {
		"type": player.REWARD_MISSION_BUY_ITEM,
		"subValue": 51501,
		"max_value": 1,
		"level_difference" : 0,
		"icon_name" : "perma_ore",
	...
	if not __localeText.has_key(type):
		if type == player.REWARD_MISSION_PASSIVE_SKILL_COMPLETE:
			...
			if subValue == 0:
				...
				missionName = "Capture Item: %s" % item.GetItemName()
