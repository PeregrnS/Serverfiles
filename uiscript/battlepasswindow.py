				...
				## Title
				{
					...
					(
						{ 
							...
							"text" : uiScriptLocale.BATTLEPASS_WINDOW_TITLE, 
									...
									(
										{
											...
											"text" : uiScriptLocale.BATTLEPASS_MISSION_NAME,
											"text_horizontal_align" : "center",
									...
									(
										{
											...
											"text" : uiScriptLocale.BATTLEPASS_MISSION_STATUS,
									...
									(
										{
											...
											"text" : uiScriptLocale.BATTLEPASS_MISSION_DESCRIPTION,
									...
									(
										{
											...
											"text" : uiScriptLocale.BATTLEPASS_EXTRA_DESCRIPTION,
					...
					(
						{
							...
							(
									...
									(
										{
											...
											"text" : uiScriptLocale.BATTLEPASS_GENERAL_INFO,
											"text_horizontal_align" : "center",
											"text_color" : 0xffffeea6,
										},
									),
								...
								
								{
									...
									"text" : uiScriptLocale.BATTLEPASS_NOT_FINISHED,
								},
								
								{
									...
									"text" : uiScriptLocale.BATTLEPASS_TOTAL_PROGRESS,
									"text_horizontal_align" : "center",
								},	
