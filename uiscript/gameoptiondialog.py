	...
	[
		{
			...
			[
				...
				{
					"name" : "titlebar",
					"type" : "titlebar_finalcore_middle",
					"style" : ["attach",],
					...
					"children" :
					[
						{ "name":"titlename", "type":"text", "x":-100, "y":30,
...
if app.ENABLE_RENDER_TARGET_PREVIEW:
	...
	window["children"][0]["children"] = window["children"][0]["children"] + [
					...
					## Show Preview Model List
					{
						"name" : "preview_model_info",
						"type" : "text",
						...
						"text" : uiScriptLocale.OPTION_PREVIEW_MODEL,
					},
					{
						"name" : "preview_model_on_button",
						"type" : "radio_button",

						"x" : LINE_DATA_X,
						"y" : CUR_LINE_Y,

						"text" : uiScriptLocale.OPTION_PREVIEW_MODEL_ON,
					...
					{
						"name" : "preview_model_off_button",
						"type" : "radio_button",

						"x" : LINE_DATA_X+MIDDLE_BUTTON_WIDTH,
						"y" : CUR_LINE_Y,

						"text" : uiScriptLocale.OPTION_PREVIEW_MODEL_OFF,
