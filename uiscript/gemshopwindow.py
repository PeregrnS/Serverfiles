...
GEM_PATH = "d:/ymir work/ui/gemshop_ex/"
GEM_ICON = "d:/ymir work/ui/gemshop_ex/gemshop_gemicon.sub"
BOARD_WIDTH = 168
BOARD_HEIGHT = 244
window = {
	"name" : "GemShopWindow",
	...
	(
		{
			...
			(
				...
				{ "name":"CurrentPageText", "type":"text", "x":BOARD_WIDTH / 2 - 0, "y":33, "text": "1/5", "text_horizontal_align":"center" },
			),
		},
	),
}
