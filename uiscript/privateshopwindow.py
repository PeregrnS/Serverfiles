				...
				(
					...
					# Information Group
					{
						...
						(
							...
							## Yang Text
							{
								"name" : "gold_text_window", "type" : "window", "style" : ("attach",), "x" : 24, "y" : 26, "width" : 178, "height" : 18,
								"children" :
								(
                                    { "name" : "gold_text_bg", "type":"expanded_image", "x":0, "y":0, "image" : ROOT_PATH + "remain_time_text_bg.sub", "x_scale" : 1.3, "y_scale" : 1.0, },
