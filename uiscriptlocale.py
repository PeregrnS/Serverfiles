...
if app.__BL_MULTI_LANGUAGE__:
	...
	def ReloadLocaleFile():
		...
		global LOCALE_INTERFACE_EX_FILE_NAME
		LOCALE_INTERFACE_EX_FILE_NAME = "%s/locale_interface_ex.txt" % (app.GetLocalePath())

		LoadLocaleFile(LOCALE_INTERFACE_FILE_NAME)
		LoadLocaleFile(LOCALE_INTERFACE_EX_FILE_NAME)
...
WINDOWS_PATH = "locale/common/ui/windows/"
MAPNAME_PATH = "locale/common/ui/mapname/"
...
LOCALE_INTERFACE_EX_FILE_NAME = "%s/locale_interface_ex.txt" % (name)
if app.__BL_MULTI_LANGUAGE__:
	LoadLocaleFile(LOCALE_INTERFACE_FILE_NAME)
	LoadLocaleFile(LOCALE_INTERFACE_EX_FILE_NAME)
else:
	LoadLocaleFile(LOCALE_INTERFACE_FILE_NAME, locals())
	LoadLocaleFile(LOCALE_INTERFACE_EX_FILE_NAME, locals())

if app.ENABLE_HUNTING_SYSTEM:
	LOCALE_MAPNAME_FILE_NAME = "%s/locale_mapnames.txt" % (name)
	if app.__BL_MULTI_LANGUAGE__:
		LoadLocaleFile(LOCALE_MAPNAME_FILE_NAME)
	else:
