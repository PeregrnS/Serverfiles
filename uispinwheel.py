...
class InfoWindow(ui.BoardWithTitleBar):
	...
	def __LoadWindow(self):
		...
		self.SetTitleName("[ Metin Spin Wheel Rewards ]")
		...
		self.__children["data"] = {
			0 : {
				...
				[0, 39070, 5], [0, 71646, 5], [0, 71646, 10], [0, 19070, 3], [0, 19070, 5],
				[1, 50515, 3], [1, 50515, 5], [1, 65792, 5], [1, 65793, 5], [1, 65794, 5],
				[1, 72064, 10], [1, 72065, 5], [1, 72066, 5], [1, 72067, 5], [1, 31000, 10],
...
class Window(ui.Window):
	...
	def __LoadWindow(self):
		...
		spinBtn = CreateWindow(ui.Button(), bg, (2, 3))
		...
		(x,y) = (100, wndMgr.GetScreenHeight() - 100)
